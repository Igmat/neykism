...
3. Несмотря на техническую **доступность** (мы почти всегда можем найти бумажный или электронный вариант описания действующей ва данном обществе Формальной системы), сложность и объём этой документации в купе со специфической терминологией (которую годами изучают на юрфаках) и огромным количеством взаимосвязей, приводят к тому, что для обывателя этот свод правил просто непонятен, что вынуждает его либо инвестировать огромное количество времени в изучение этой предметной области (на что готовы очень немногие), либо доверять чьей-то упрощённой трактовке, которая умышленно или не умышленно может искажать действительное положение вещей.
